...
CHARACTERS = {
    ...
    P200:[128, 0, 16, 8], P400:[144, 0, 16, 8], P800:[160, 0, 16, 8], P1600:[176, 0, 16, 8],
    P100:[128, 8, 16, 8], P300:[144, 8, 16, 8], P700:[160, 8, 16, 8], P1000:[176, 8, 24, 8], P2000:[200, 8, 24, 8], P3000:[224, 8, 24, 8]
}
...
TEMP_SCORE = (CHARACTERS[N0], CHARACTERS[N0])
SCORE_DICT = {}
HIGH_SCORE_DICT = SCORE_DICT
GHOST_POINTS = []
FRUIT_POINTS = []
